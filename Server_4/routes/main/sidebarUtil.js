module.exports = {
    getUserContext : (hash) => {
        ...
        hash['sidebarContent'] = [
            ...
            ${hash.isAdmin ? '<a href="/dashboard" class="addProjectBtn" style="margin-top:1em"> Switch<br>user mode <div class="addSphere"><i class="fi fi-rr-angle-small-right"></i></div> </a>' : ''}`
        ]
        return hash;
    },
