...
function initSlider() {
    ...
    if (!recentImagesData || recentImagesData.length === 0) {
        projectImage.innerHTML = '<p style="color:#aaa; text-align:center; line-height: 200px;">No recent analysis</p>';
        return;
    }
...
function updateImageDisplay() {
    ...
    if (currentData && currentData.image) {
        ...
        // 또는 img 태그를 넣는 방식이라면:
        // projectImage.innerHTML = `<img src="${currentData.image}" alt="${currentData.name}" style="width:100%; height:100%; object-fit:cover;">`;
    }
}